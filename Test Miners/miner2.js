...
const manu2_sign = ec.keyFromPrivate('ddd0b6e733f2dbc974468c0536616679591f70dae94ea97050efd70a4e383df5')
...
const PORT = 3001;
const peers = ['ws://localhost:3000' , 'ws://localhost:3002'];
...
console.log("Manufacturer ID (Public Add) : ",manu2_id)
console.log()
...
function interactWithChain(choice){
    ...
    switch(choice){
        ...
        case 4:
            ...
            const data1 = new blockData(manu2_id , `Drug ID ${rand}` , `Drug Name ${rand}`);
            blockData.signDrug(manu2_sign , data1)
